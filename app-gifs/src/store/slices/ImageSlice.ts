...
import { ResultLinks, ResultTopicSubmissions, Tag, Urls, User } from '../../interfaces/image.interface';
...
export const ImageSlice = createSlice({
    ...
    initialState,
    reducers: {
        loadImages: (state, action: PayloadAction<boolean>) => {
...
export const { loadImages, setImages } = ImageSlice.actions;
export { }